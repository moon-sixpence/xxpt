...
<HTML xmlns="http://www.w3.org/1999/xhtml">
  ...
  <BODY>
      <DIV style="MARGIN: 0px auto; WIDTH: 936px;margin-top: 150px;font-family: 微软雅黑;font-size: 40px;">
                           大学生学习交流网站
      </DIV>
      <DIV style="BACKGROUND-COLOR: #278296;margin-top: 40px;">
	      <DIV style="MARGIN: 0px auto; WIDTH: 936px">
		      <DIV style="BACKGROUND: url(<%=path %>/images/body_05.jpg) no-repeat; HEIGHT: 190px">
				      ...
				      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				          ...
				          <TR>
					          <TD style="HEIGHT: 30px">
					              ...
					              <INPUT type=text name=userPw style="width: 110px;">
					          </TD>
				          </TR>
				          <TR>
					          <TD style="HEIGHT: 50px">
					              <span style="font-family: 微软雅黑;font-size: 18px;"> 类型：</span>
					              ...
					              <input type="button" value="登陆" style="width: 90px;" onclick='check1()'>
